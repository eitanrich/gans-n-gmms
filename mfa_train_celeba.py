...
from training import mfa_sgd_training
import mfa_utils
import mfa
...
def main(argv):
    ...
    parser.add_argument('--num_components', help='Number of (root level) mixture components', default=20)
    parser.add_argument('--samples_per_sub_component', help='For hierarchic (two-level) training, target number of samples per final component', default=500)
    ...
    #                  learning_rate=2e-5, max_iters=max_iters)
    gmm_model = mfa.MFA()
