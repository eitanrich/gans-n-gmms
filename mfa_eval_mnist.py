...
def main(argv):
    ...
    # model_folder = '/cs/usr/eitanrich/phd-work-local/GenTrain/Results/MNIST-28x28-256C-4L-256B-5e-05LR-KMFA-diag-DStd'
    # gmm_model.load(os.path.join(os.path.join(model_folder, 'model', 'gmm_hd_model')))
    ...
    samples_from_provider = mfa_provider.get_images_from_list(['{}.png'.format(i) for i in range(100)])
